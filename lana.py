...
def motility_plot(velocities, turning_angles, displacements, times='',
        legends='', ndim=2, save_as='', palette='deep'):
    ...
    for turning_angle in turning_angles:
        if ndim == 2: # Mirror data to get flat boundaries
...
def motility_classes_plot(motilities, save_as='', palette='deep'):
...
class Motility:
    ...
    def plot(self, *args, **kwargs):
        motility_classes_plot(self, *args, **kwargs)
